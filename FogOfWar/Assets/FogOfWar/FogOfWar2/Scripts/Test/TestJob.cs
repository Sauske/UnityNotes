...
namespace ASL.FogOfWar
{
    public class TestJob : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                m_JobDatas[i] = new float3(Random.Range(1, 100), Random.Range(1, 100), Random.Range(1, 100));
                m_NormalDatas[i] = new Vector3(Random.Range(1, 100), Random.Range(1, 100), Random.Range(1, 100));
            }
        }
