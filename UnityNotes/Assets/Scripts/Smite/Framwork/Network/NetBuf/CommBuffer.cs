...
public partial class CommBufBase: Framework.PooledClassObject
{
    public CommBufBase()
    {
        bChkReset = false;
...
public class CommMemoryStream : CommBufBase
{
    ...
    public void set(ProtoBuf.IExtensible msg)
    {
        _reset();
        if (msg !=null)
            ProtoBuf.Serializer.Serialize<ProtoBuf.IExtensible>(ms, msg);
    }
...
public class CommWriteBuf : CommBufBase
{
    private byte[] beginPtr;
    private Int32 position;
    private Int32 length;   //Buff的大小
    ...
    private void _set(ref byte[] ptr, Int32 len, Int32 offset)
    {
        beginPtr = ptr;
        position = 0;
        length = 0;
    ...
    public CommWriteBuf(ref byte[] ptr, Int32 len, Int32 offset)
    {
        _set(ref ptr, len, offset);
    }
    ...
    public void set(ref byte[] ptr, int len, int offset)
    {
        _set(ref ptr, len, offset);
    }
    ...
    public CommError.Type writeByteArrar(byte[] src,Int32 len)
    {
        if (null == beginPtr || null == src)
        {
#if (DEBUG)
            StackTrace st = new StackTrace(true);
            for (int i = 0; i < st.FrameCount; i++)
        ...
        Array.Copy(src, 0, beginPtr, position, len);
        position += len;
        return CommError.Type.COMM_NO_ERROR;
    }
...
public class CommReadBuf : CommBufBase
{
    private byte[] beginPtr;
    private Int32 position;
    ...
    public CommReadBuf(ref byte[] ptr, Int32 len, Int32 offset)
    {
        set(ref ptr, len, offset);
    }
    ...
    public void set(ref byte[] ptr, Int32 len,Int32 offset)
    {
        beginPtr = ptr;
        position = 0;
        length = 0;
    ...
    public CommError.Type readByteArray(ref byte[] dest, Int32 count)
    {
