...
public abstract partial class ListViewBase
{
    ...
    IEnumerable<T>    
{
    public ListView()
    {
        ...
        DebugHelper.Assert(
            ...
            "Performance Warning! ListView Should Not Contain Value Type!!!! T is type {0}",
            typeof(T).Name
            );
#endif
    }
...
public partial class ListLinqView<T> : ListView<T>
{
    public ListLinqView() :
        base()
    {
	...
	public ListLinqView(int capacity) :
		base(capacity)
	{
	}
...
public partial class DictionaryView<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
{
...
*/
public partial class DictionaryObjectView<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
{
